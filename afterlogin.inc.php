...
<!-- 
  ...
  <body>
    ...
    <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">SITBLC</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#tf-thingstoknow" class="page-scroll">Things to know</a></li>
    ...
    <div id="tf-home" class="text-center">
        <div class="overlay">
            <div class="content">
                <h1>Welcome <?php echo $username; ?>on <strong><span class="color">SITBLC</span></strong></h1>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 service">
                    <a href=""><img src="img/services/02.jpg" alt="..." class="img-circle team-img">
                    <h4><strong>Lawyer Hiring</strong></h4></a>
                    <p>Hire best of Lawyers according to your preferences.</p>
                </div>

                <div class="col-md-3 col-sm-6 service">
                     <a href=""><img src="img/services/03.jpg" alt="..." class="img-circle team-img">
                ...
                <div class="col-md-3 col-sm-6 service">
                    <a href="lostandfound.html"><img src="img/services/04.jpg" alt="..." class="img-circle team-img">
                ...
                <div class="col-md-3 col-sm-6 service">
                    <a href="missingperson.php"><img src="img/services/05.jpg" alt="..." class="img-circle team-img">
                ...
                <div class="col-md-3 col-sm-6 service">
                    <a href=""><img src="img/services/06.jpg" alt="..." class="img-circle team-img">
                ...
                <div class="col-md-3 col-sm-6 service">
                    <a href=""><img src="img/services/07.jpg" alt="..." class="img-circle team-img">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div id="testimonial" class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                ...
                                <p><strong>Shrinath Shinde</strong><br> Sub-Inspector <br> Anand Police</p><hr><hr><hr>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    ==========================================-->
    <div id="tf-thingstoknow" class="text-center">
        <div class="overlay">
            <div class="container">
                <div class="section-title center">
                    <h2>Some things<strong> that you should be aware of..</strong></h2>
                    <div class="line">
