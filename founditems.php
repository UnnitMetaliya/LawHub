        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">  
                ...
                <div class="section-title center">
                    <h2> <strong>ITEMS THAT PEOPLE HAVE FOUND</strong></h2>
                    <div class="line">
                        <hr>
                    </div>
                ...
                <div id="founditemlist">
                    ...
                    <?php 
                        ...
                        $dbLink = new mysqli('127.0.0.1', 'root', '', 'lostandfound');
                            ...
                            $sql = 'SELECT `id`,`founder_name`,`founder_email`, `contact_no`,`item_name`,`item_description`,`location` FROM `lost`';
          ...
          echo '<p>There are no any items there..! Have a good day..!</p>';
                ...
                echo '<table width="100%" id="manifest">
                          <tr style="background-color:#FCAC45">
                            <td><b>Founder Name</b></td>
                            <td><b>Founder Email</b></td> 
